...
class TestChromeImportPlugin:
    """Tests for the ChromeImportPlugin class."""

    def test_get_name(self):
        """Test that get_name returns the correct name."""
        assert ChromeImportPlugin.get_name() == "chrome"

    def test_get_description(self):
        """Test that get_description returns a non-empty description."""
        description = ChromeImportPlugin.get_description()
