    ...
    def test_enex_to_csv_conversion(self):
        ...
        try:
            ...
            with open(output_csv, encoding="utf-8") as f:
                ...
                assert "This is a sample note" in rows[0]["description"], (
                    f"Unexpected description: {rows[0]['description']}"
                )
                assert rows[0]["url"] == "http://example.com/note1", (
                ...
                assert "This is another sample note" in rows[1]["description"], (
                    f"Unexpected description: {rows[1]['description']}"
                )
                assert rows[1]["url"] == "http://example.com/note2", (
